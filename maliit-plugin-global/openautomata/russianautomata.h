...
#ifndef RUSSIAN_AUTOMATA_H
#define RUSSIAN_AUTOMATA_H

#include "automatabase.h"
#include <QLocale>

class RussianAutomata: public AutomataBase
{
...
public:
    RussianAutomata() {
        ...
        m_keymap.insert(0x007e,QString(QChar(0x401)));
        m_keymap.insert(0x007b,QString(QChar(0x425)));
        m_keymap.insert(0x007d,QString(QChar(0x42A)));
        m_keymap.insert(0x003a,QString(QChar(0x416)));
        m_keymap.insert(0x0022,QString(QChar(0x42D)));
    ...
    {
        return new RussianAutomata();
    }
};

#endif // RUSSIAN_AUTOMATA_H
