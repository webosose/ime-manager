...
private:
    ...
    void addSymbolKeys()
    {
        ...
        m_keymap.insert(0x22,QString(0x106));
    ...
    void addShiftKeys()
    {
        m_keymap.insert(0x3a,QString(0x10C));
        m_keymap.insert(0x3b,QString(0x10D));
        m_keymap.insert(0x3c,QString(0x3B));
        m_keymap.insert(0x3d,QString(0x2B));
        ...
        m_keymap.insert(0x5b,QString(0x0161));
        m_keymap.insert(0x5c,QString(0x17E));
        m_keymap.insert(0x5d,QString(0x111));
        m_keymap.insert(0x5e,QString(0x26));
        m_keymap.insert(0x5f,QString(0x3f));
        m_keymap.insert(0x60,QString(0xB8));
    }
    ...
    void addNormalKeys()
    {
        ...
        m_keymap.insert(0x7b,QString(0x160));
        m_keymap.insert(0x7c,QString(0x17D));
        m_keymap.insert(0x7d,QString(0x110));
        m_keymap.insert(0x7e,QString(0xA8));
    ...
    void addAccentKeys()
    {
        ...
        m_keymap.insert(0x00f2,QString(0x00f2));
        m_keymap.insert(0x00f4,QString(0x00f4));
        m_keymap.insert(0x00f8,QString(0x00f8));
        m_keymap.insert(0x00d3,QString(0x00d3));
        m_keymap.insert(0x00d2,QString(0x00d2));
        m_keymap.insert(0x00d4,QString(0x00d4));
        m_keymap.insert(0x00d8,QString(0x00d8));
    }
    ...
    void addAltKeysForHID()
    {
        ...
        m_keymap.insert(0xA4,QString(0x00B0));
