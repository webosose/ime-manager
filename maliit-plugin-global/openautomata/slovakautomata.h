...
private:
    ...
    void addSymbolKeys()
    {
        ...
        m_keymap.insert(0x22,QString(QChar(0x21)));
    ...
    void addNumberKeys()
    {
        m_keymap.insert(0x30,QString(QChar(0xE9)));
        m_keymap.insert(0x31,QString(QChar(0x2B)));
        m_keymap.insert(0x32,QString(QChar(0x13E)));
        m_keymap.insert(0x33,QString(QChar(0x0161)));
        m_keymap.insert(0x34,QString(QChar(0x010D)));
        m_keymap.insert(0x35,QString(QChar(0x0165)));
        m_keymap.insert(0x36,QString(QChar(0x017E)));
        m_keymap.insert(0x37,QString(QChar(0xFD)));
        m_keymap.insert(0x38,QString(QChar(0xE1)));
        m_keymap.insert(0x39,QString(QChar(0xED)));
    }

    void addShiftKeys()
    {
        m_keymap.insert(0x3a,QString(QChar(0x22)));
        m_keymap.insert(0x3b,QString(QChar(0xF4)));
        m_keymap.insert(0x3c,QString(QChar(0x3F)));
        ...
        m_keymap.insert(0x5b,QString(QChar(0xFA)));
        m_keymap.insert(0x5c,QString(QChar(0x0148)));
        m_keymap.insert(0x5d,QString(QChar(0xE4)));
        m_keymap.insert(0x5e,QString(QChar(0x36)));
        m_keymap.insert(0x5f,QString(QChar(0x25)));
    }

    void addNormalKeys()
    {
        m_keymap.insert(0x60,QString(QChar(0x3B)));
        ...
        m_keymap.insert(0x7b,QString(QChar(0x2F)));
        m_keymap.insert(0x7c,QString(QChar(0x29)));
        m_keymap.insert(0x7d,QString(QChar(0x28)));
    ...
    void addAccentKeys()
    {
        ...
        m_keymap.insert(0x00e4,QString(QChar(0x00e4)));
        m_keymap.insert(0x010d,QString(QChar(0x010d)));
        m_keymap.insert(0x010f,QString(QChar(0x010f)));
        m_keymap.insert(0x00e9,QString(QChar(0x00e9)));
        m_keymap.insert(0x00ed,QString(QChar(0x00ed)));
        m_keymap.insert(0x013e,QString(QChar(0x013e)));
        m_keymap.insert(0x0148,QString(QChar(0x0148)));
        m_keymap.insert(0x00f3,QString(QChar(0x00f3)));
        m_keymap.insert(0x00f4,QString(QChar(0x00f4)));
        m_keymap.insert(0x0155,QString(QChar(0x0155)));
        m_keymap.insert(0x0161,QString(QChar(0x0161)));
        m_keymap.insert(0x0165,QString(QChar(0x0165)));
        m_keymap.insert(0x00fa,QString(QChar(0x00fa)));
        m_keymap.insert(0x00fd,QString(QChar(0x00fd)));
        m_keymap.insert(0x017e,QString(QChar(0x017e)));
        m_keymap.insert(0x0c11,QString(QChar(0x00c1)));
        m_keymap.insert(0x00c41,QString(QChar(0x00c4)));
        m_keymap.insert(0x010c,QString(QChar(0x010c)));
        m_keymap.insert(0x010e,QString(QChar(0x010e)));
        m_keymap.insert(0x0c91,QString(QChar(0x00c9)));
        m_keymap.insert(0x0cd1,QString(QChar(0x00cd)));
        m_keymap.insert(0x013d,QString(QChar(0x013d)));
        m_keymap.insert(0x0147,QString(QChar(0x0147)));
        m_keymap.insert(0x00d3,QString(QChar(0x00d3)));
        m_keymap.insert(0x00d4,QString(QChar(0x00d4)));
        m_keymap.insert(0x0154,QString(QChar(0x0154)));
        m_keymap.insert(0x0160,QString(QChar(0x0160)));
        m_keymap.insert(0x0164,QString(QChar(0x0164)));
        m_keymap.insert(0x00da,QString(QChar(0x00da)));
        m_keymap.insert(0x00dd,QString(QChar(0x00dd)));
        m_keymap.insert(0x017d,QString(QChar(0x017d)));
        m_keymap.insert(0x401,QString(QChar(0x40)));
    }

    void addAltKeysForHID()
    {
        m_keymap.insert(0xA0,QString(QChar(0x7E)));
        m_keymap.insert(0xA1,QString(QChar(0x02C7)));
        m_keymap.insert(0xA2,QString(QChar(0x5E)));
        m_keymap.insert(0xA3,QString(QChar(0x02D8)));
        m_keymap.insert(0xA4,QString(QChar(0xB0)));
        ...
        m_keymap.insert(0xA8,QString(QChar(0xB4)));
        ...
        m_keymap.insert(0xC4,QString(QChar(0xA4)));
        m_keymap.insert(0xAC,QString(QChar(0x5C)));
        m_keymap.insert(0xAD,QString(QChar(0x7C)));
        m_keymap.insert(0xAE,QString(QChar(0x20AC)));
        m_keymap.insert(0xB5,QString(QChar(0x27)));
        m_keymap.insert(0xB6,QString(QChar(0xF7)));
        m_keymap.insert(0xB7,QString(QChar(0xD7)));
        m_keymap.insert(0xB9,QString(QChar(0x111)));
        m_keymap.insert(0xBA,QString(QChar(0x110)));
        m_keymap.insert(0xBB,QString(QChar(0x5B)));
        m_keymap.insert(0xBC,QString(QChar(0x5D)));
        m_keymap.insert(0xBF,QString(QChar(0x142)));
        m_keymap.insert(0xC0,QString(QChar(0x141)));
        m_keymap.insert(0xC1,QString(QChar(0x24)));
        m_keymap.insert(0xC2,QString(QChar(0xDF)));
        m_keymap.insert(0xC5,QString(QChar(0x3E)));
        m_keymap.insert(0xC6,QString(QChar(0x23)));
        m_keymap.insert(0xC7,QString(QChar(0x26)));
        m_keymap.insert(0xC8,QString(QChar(0x40)));
        m_keymap.insert(0xC9,QString(QChar(0x7B)));
        m_keymap.insert(0xCA,QString(QChar(0x7D)));
        m_keymap.insert(0xCC,QString(QChar(0x3C)));
        m_keymap.insert(0xCD,QString(QChar(0x3E)));
        m_keymap.insert(0xCE,QString(QChar(0x2A)));
    }
