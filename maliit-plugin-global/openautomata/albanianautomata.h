...
#ifndef ALBANIAN_AUTOMATA_H
#define ALBANIAN_AUTOMATA_H

#include "automatabase.h"

class AlbanianAutomata : public AutomataBase
{
...
private:
    ...
    void addAccentKeys()
    {
        ...
        m_keymap.insert(0xccb,QString(QChar(0xcb)));
    }
