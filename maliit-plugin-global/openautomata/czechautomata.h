...
private:
    void addSymbolKeys()
    {
        m_keymap.insert(0x60,QString(QChar(0x003B)));
        m_keymap.insert(0x31,QString(QChar(0x002B)));
        m_keymap.insert(0x32,QString(QChar(0x011B)));
        m_keymap.insert(0x33,QString(QChar(0x0161)));
        m_keymap.insert(0x34,QString(QChar(0x010D)));
        m_keymap.insert(0x35,QString(QChar(0x0159)));
        m_keymap.insert(0x36,QString(QChar(0x017E)));
        m_keymap.insert(0x37,QString(QChar(0x00FD)));
        m_keymap.insert(0x38,QString(QChar(0x00E1)));
        m_keymap.insert(0x39,QString(QChar(0x00ED)));
        m_keymap.insert(0x30,QString(QChar(0x00E9)));
        m_keymap.insert(0x2D,QString(QChar(0x003D)));
        m_keymap.insert(0x3D,QString(QChar(0x00B4)));
        m_keymap.insert(0x5C,QString(QChar(0x00A8)));
        m_keymap.insert(0x5B,QString(QChar(0x00FA)));
        m_keymap.insert(0x5D,QString(QChar(0x0029)));
        m_keymap.insert(0x3B,QString(QChar(0x016F)));
        m_keymap.insert(0x27,QString(QChar(0x00A7)));
        // Shifted Symbols
        m_keymap.insert(0x7E,QString(QChar(0x02DA)));
        m_keymap.insert(0x5F,QString(QChar(0x0025)));
        m_keymap.insert(0x2B,QString(QChar(0x02C7)));
        m_keymap.insert(0x7B,QString(QChar(0x002F)));
        m_keymap.insert(0x7D,QString(QChar(0x0028)));
        m_keymap.insert(0x3A,QString(QChar(0x0022)));
        m_keymap.insert(0x22,QString(QChar(0x0021)));
    ...
    void addNumberKeys()
    {
        ...
        m_keymap.insert(0x25,QString(QChar(0x0035)));
        m_keymap.insert(0x5E,QString(QChar(0x0036)));
        m_keymap.insert(0x26,QString(QChar(0x0037)));
        m_keymap.insert(0x2A,QString(QChar(0x0038)));
        m_keymap.insert(0x28,QString(QChar(0x0039)));
        m_keymap.insert(0x29,QString(QChar(0x0030)));
    }
    ...
    void addAccentKeys()
    {
        m_keymap.insert(0xe1,QString(QChar(0xe1)));
        m_keymap.insert(0x1e8,QString(QChar(0x10D)));
        m_keymap.insert(0x1ef,QString(QChar(0x10F)));
        m_keymap.insert(0xe9,QString(QChar(0xe9)));
        m_keymap.insert(0x1ec,QString(QChar(0x11B)));
        m_keymap.insert(0xed,QString(QChar(0xed)));
        m_keymap.insert(0x1f2,QString(QChar(0x148)));
        m_keymap.insert(0xf3,QString(QChar(0xf3)));
        m_keymap.insert(0x1f8,QString(QChar(0x159)));
        m_keymap.insert(0x1b9,QString(QChar(0x161)));
        m_keymap.insert(0x1bb,QString(QChar(0x165)));
        m_keymap.insert(0xfd,QString(QChar(0xfd)));
        m_keymap.insert(0x1be,QString(QChar(0x17E)));
        m_keymap.insert(0xDF,QString(QChar(0xc1)));
        m_keymap.insert(0x1c8,QString(QChar(0x10C)));
        m_keymap.insert(0x1cf,QString(QChar(0x10E)));
        m_keymap.insert(0x0111,QString(QChar(0xc9)));
        m_keymap.insert(0x1cc,QString(QChar(0x11A)));
        m_keymap.insert(0x110,QString(QChar(0xcd)));
        m_keymap.insert(0x1d2,QString(QChar(0x147)));
        m_keymap.insert(0xd3,QString(QChar(0xd3)));
        m_keymap.insert(0x1d8,QString(QChar(0x158)));
        m_keymap.insert(0x1a9,QString(QChar(0x160)));
        m_keymap.insert(0x1ab,QString(QChar(0x164)));
        m_keymap.insert(0xdd,QString(QChar(0xdd)));
        m_keymap.insert(0x1ae,QString(QChar(0x17D)));
    }
    ...
    void addAltKeysForHID()
    {
        ...
        m_keymap.insert(0xB9,QString(QChar(0x0111)));
        m_keymap.insert(0xBA,QString(QChar(0x0110)));
        ...
        m_keymap.insert(0xC1,QString(QChar(0x0024)));
        m_keymap.insert(0xC2,QString(QChar(0x00DF)));
        m_keymap.insert(0xC6,QString(QChar(0x0023)));
        m_keymap.insert(0xC7,QString(QChar(0x0026)));
        ...
        m_keymap.insert(0xCE,QString(QChar(0x002A)));
    }
};
