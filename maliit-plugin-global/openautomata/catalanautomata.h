...
private:
    void addSymbolKeys()
    {
        ...
        m_keymap.insert(0x23,QString(0xB7));
        ...
        m_keymap.insert(0x2B,QString(0xBF));
    ...
    void addShiftKeys()
    {
        ...
        m_keymap.insert(0x7B,QString(0x0302));
        ...
        m_keymap.insert(0x3A,QString(0xD1));
        m_keymap.insert(0x22,QString(0x0308));
    ...
    void addNormalKeys()
    {
        ...
        m_keymap.insert(0x5B,QString(0x0300));
        ...
        m_keymap.insert(0x3B,QString(0xF1));
        m_keymap.insert(0x27,QString(0x0301));
     ...
     {
		 //lower case
         m_keymap.insert(0x60,QString(0xBA));
         m_keymap.insert(0x5C,QString(0xE7));
		 //upper case
         m_keymap.insert(0x7E,QString(0xAA));
         m_keymap.insert(0x7C,QString(0xC7));
     }
