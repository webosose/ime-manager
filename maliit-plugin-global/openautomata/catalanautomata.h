...
#ifndef CATALAN_AUTOMATA_H
#define CATALAN_AUTOMATA_H

#include "automatabase.h"
#include <QLocale>

class CatalanAutomata : public AutomataBase
{
...
private:
    void addSymbolKeys()
    {
        ...
        m_keymap.insert(0x23,QString(QChar(0xB7)));
        ...
        m_keymap.insert(0x2B,QString(QChar(0xBF)));
    ...
    void addShiftKeys()
    {
        ...
        m_keymap.insert(0x7B,QString(QChar(0x0302)));
        ...
        m_keymap.insert(0x3A,QString(QChar(0xD1)));
        m_keymap.insert(0x22,QString(QChar(0x0308)));
    ...
    void addNormalKeys()
    {
        ...
        m_keymap.insert(0x5B,QString(QChar(0x0300)));
        ...
        m_keymap.insert(0x3B,QString(QChar(0xF1)));
        m_keymap.insert(0x27,QString(QChar(0x0301)));
     ...
     {
		 //lower case
         m_keymap.insert(0x60,QString(QChar(0xBA)));
         m_keymap.insert(0x5C,QString(QChar(0xE7)));
		 //upper case
         m_keymap.insert(0x7E,QString(QChar(0xAA)));
         m_keymap.insert(0x7C,QString(QChar(0xC7)));
     }

};
#endif // CATALAN_AUTOMATA_H
