...
private:
    ...
    void addNormalKeys()
    {
        ...
        m_keymap.insert(0x5c,QString(QChar(0x02D9)));
    ...
    void addAccentKeys()
    {
        m_keymap.insert(0x03e0,QString(QChar(0x101)));
        m_keymap.insert(0x1e8,QString(QChar(0x10D)));
        m_keymap.insert(0x03ba,QString(QChar(0x113)));
        m_keymap.insert(0x03bb,QString(QChar(0x123)));
        m_keymap.insert(0x03ef,QString(QChar(0x12B)));
        m_keymap.insert(0x03f3,QString(QChar(0x137)));
        m_keymap.insert(0x03b6,QString(QChar(0x13C)));
        m_keymap.insert(0x03f1,QString(QChar(0x146)));
        m_keymap.insert(0x01b9,QString(QChar(0x161)));
        m_keymap.insert(0x03fe,QString(QChar(0x16B)));
        m_keymap.insert(0x01be,QString(QChar(0x17E)));
        m_keymap.insert(0x03c0,QString(QChar(0x100)));
        m_keymap.insert(0x01c8,QString(QChar(0x10C)));
        m_keymap.insert(0x03aa,QString(QChar(0x112)));
        m_keymap.insert(0x03ab,QString(QChar(0x122)));
        m_keymap.insert(0x03cf,QString(QChar(0x12A)));
        m_keymap.insert(0x03d3,QString(QChar(0x136)));
        m_keymap.insert(0x03a6,QString(QChar(0x13B)));
        m_keymap.insert(0x03d1,QString(QChar(0x145)));
        m_keymap.insert(0x01a9,QString(QChar(0x160)));
        m_keymap.insert(0x03de,QString(QChar(0x16A)));
        m_keymap.insert(0x01ae,QString(QChar(0x17D)));
    }
    ...
    {
        m_accentKeymap.insert(QString(QChar(0x02D9))+QString(QChar(0x65)),QString(QChar(0x0117)));
        m_accentKeymap.insert(QString(QChar(0x02D9))+QString(QChar(0x61)),QString(QChar(0x00E5)));
        m_accentKeymap.insert(QString(QChar(0x02D9))+QString(QChar(0x67)),QString(QChar(0x0121)));
        m_accentKeymap.insert(QString(QChar(0x02D9))+QString(QChar(0x7A)),QString(QChar(0x017C)));
        m_accentKeymap.insert(QString(QChar(0x02D9))+QString(QChar(0x45)),QString(QChar(0x0116)));
        m_accentKeymap.insert(QString(QChar(0x02D9))+QString(QChar(0x41)),QString(QChar(0x00C5)));
    ...
    {
        m_keymap.insert(0xA1,QString(QChar(0x00AB)));
        m_keymap.insert(0xA2,QString(QChar(0x00BB)));
        m_keymap.insert(0xA3,QString(QChar(0x20AC)));
        m_keymap.insert(0xA5,QString(QChar(0x2019)));
        m_keymap.insert(0xAA,QString(QChar(0x2013)));
        m_keymap.insert(0xAE,QString(QChar(0x0113)));
        m_keymap.insert(0xAF,QString(QChar(0x0157)));
        m_keymap.insert(0xB2,QString(QChar(0x016B)));
        m_keymap.insert(0xB3,QString(QChar(0x012B)));
        m_keymap.insert(0xB4,QString(QChar(0xF5)));
        m_keymap.insert(0xB8,QString(QChar(0x0101)));
        m_keymap.insert(0xB9,QString(QChar(0x0161)));
        m_keymap.insert(0xBC,QString(QChar(0x0123)));
        m_keymap.insert(0xBF,QString(QChar(0x0137)));
        m_keymap.insert(0xC0,QString(QChar(0x013C)));
        m_keymap.insert(0xC2,QString(QChar(0x00B4)));
        m_keymap.insert(0xC4,QString(QChar(0x02D9)));
        m_keymap.insert(0xC5,QString(QChar(0x017E)));
        m_keymap.insert(0xC7,QString(QChar(0x010D)));
        m_keymap.insert(0xCA,QString(QChar(0x0146)));
    }

    void addShiftedAltKeysForHID()
    {
        m_keymap.insert(0xDD,QString(QChar(0xA7)));
        m_keymap.insert(0xDE,QString(QChar(0xB0)));
        m_keymap.insert(0xE0,QString(QChar(0xB1)));
        m_keymap.insert(0xE1,QString(QChar(0xD7)));
        m_keymap.insert(0xE4,QString(QChar(0x2014)));
        m_keymap.insert(0xE8,QString(QChar(0x112)));
        m_keymap.insert(0xE9,QString(QChar(0x156)));
        m_keymap.insert(0xEC,QString(QChar(0x16A)));
        m_keymap.insert(0xED,QString(QChar(0x12A)));
        m_keymap.insert(0xEE,QString(QChar(0xD5)));
        m_keymap.insert(0xF2,QString(QChar(0x100)));
        m_keymap.insert(0xF3,QString(QChar(0x160)));
        m_keymap.insert(0xF6,QString(QChar(0x122)));
        m_keymap.insert(0xF9,QString(QChar(0x136)));
        m_keymap.insert(0xFA,QString(QChar(0x13B)));
        m_keymap.insert(0xFC,QString(QChar(0xA8)));
        m_keymap.insert(0xFF,QString(QChar(0x17D)));
        m_keymap.insert(0x101,QString(QChar(0x10C)));
        m_keymap.insert(0x104,QString(QChar(0x145)));
    }
};
