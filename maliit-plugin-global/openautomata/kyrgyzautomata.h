...
private:
    ...
    void addAccentKeys()
    {
       ...
       m_keymap.insert(0x06b3,QString(0x401));
    }

    void addAltKeysForHID()
    {
      m_keymap.insert(0xAE,QString(0x04af));
      m_keymap.insert(0xB1,QString(0x04a3));
      m_keymap.insert(0xBE,QString(0x04e9));
    }

    void addAltShiftedKeys()
    {
      m_keymap.insert(0xE8,QString(0x04ae));
      m_keymap.insert(0xEB,QString(0x04a2));
      m_keymap.insert(0xF8,QString(0x04e8));
    }
};
