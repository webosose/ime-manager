...
public:
    ArabicAutomata()
    {
        ...
        m_keymap.insert(0x30,QString(QChar(0x660)));
        m_keymap.insert(0x31,QString(QChar(0x661)));
        m_keymap.insert(0x32,QString(QChar(0x662)));
        m_keymap.insert(0x33,QString(QChar(0x663)));
        m_keymap.insert(0x34,QString(QChar(0x664)));
        m_keymap.insert(0x35,QString(QChar(0x665)));
        m_keymap.insert(0x36,QString(QChar(0x666)));
        m_keymap.insert(0x37,QString(QChar(0x667)));
        m_keymap.insert(0x38,QString(QChar(0x668)));
        m_keymap.insert(0x39,QString(QChar(0x669)));
        ...
        m_keymap.insert(0x61F,QString(QChar(0x3F)));
        m_keymap.insert(0x40,QString(QChar(0x40)));
        m_keymap.insert(0x41,QString(QChar(0x650)));
        ...
        m_keymap.insert(0x53,QString(QChar(0x64D)));
        ...
        m_keymap.insert(0x5b,QString(QChar(0x3E)));
        m_keymap.insert(0x5c,QString(QChar(0x7C)));
        m_keymap.insert(0x5d,QString(QChar(0x3C)));
        ...
        m_keymap.insert(0x7b,QString(QChar(0x62C)));
        m_keymap.insert(0x7c,QString(QChar(0x7c)));
        m_keymap.insert(0x7d,QString(QChar(0x62F)));
        m_keymap.insert(0x7e,QString(QChar(0x651)));
        m_keymap.insert(0x651,QString(QChar(0x7E)));
