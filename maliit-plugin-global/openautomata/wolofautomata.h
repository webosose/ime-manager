...
private:
    void addNumberKeys()
    {
        m_keymap.insert(0x30,QString(0xE0));
        m_keymap.insert(0x31,QString(0x26));
        m_keymap.insert(0x32,QString(0xE9));
        ...
        m_keymap.insert(0x37,QString(0xF1));
        m_keymap.insert(0x38,QString(0x5F));
        m_keymap.insert(0x39,QString(0x014B));
    }

    void addSymbolKeys()
    {
        m_keymap.insert(0x60,QString(0xE3));
        m_keymap.insert(0x7E,QString(0xC3));
        m_keymap.insert(0x2D,QString(0x29));
        m_keymap.insert(0x3D,QString(0x3D));
        m_keymap.insert(0x2B,QString(0x2B));
        m_keymap.insert(0x5B,QString(0x5E));
        m_keymap.insert(0x5D,QString(0xF3));
        m_keymap.insert(0x7B,QString(0xA8));
        m_keymap.insert(0x7D,QString(0xD3));
        m_keymap.insert(0x27,QString(0xF9));
        m_keymap.insert(0x22,QString(0xC0));
        m_keymap.insert(0x5C,QString(0x2A));
        m_keymap.insert(0x7C,QString(0xD1));
        ...
        m_keymap.insert(0x3F,QString(0x014A));
        m_keymap.insert(0x5F,QString(0xC9));
    }
    ...
    {
        m_keymap.insert(0xA1,QString(0x7E));
