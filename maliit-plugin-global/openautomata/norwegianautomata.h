...
private:
    ...
    void addSymbolKeys()
    {
        m_keymap.insert(0x60,QString(QChar(0x7C)));
        m_keymap.insert(0x3B,QString(QChar(0xF8)));
        m_keymap.insert(0x3A,QString(QChar(0xD8)));
        m_keymap.insert(0x27,QString(QChar(0xE6)));
        m_keymap.insert(0x22,QString(QChar(0xC6)));
        ...
        m_keymap.insert(0x3D,QString(QChar(0x5C)));
    ...
    void addAltKeysForHID()
    {
        ...
        m_keymap.insert(0xAB,QString(QChar(0x00B4)));
