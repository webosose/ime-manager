...
private:
    ...
    void addSymbolKeys()
    {
        m_keymap.insert(0x60,QString(0x005D));
        m_keymap.insert(0x7E,QString(0x005B));
        ...
        m_keymap.insert(0x5C,QString(0x00E2));
        m_keymap.insert(0x7C,QString(0x00C2));
        m_keymap.insert(0x5B,QString(0x0103));
        m_keymap.insert(0x7B,QString(0x0102));
        m_keymap.insert(0x5D,QString(0x00EE));
        m_keymap.insert(0x7D,QString(0x00CE));
        m_keymap.insert(0x3B,QString(0x015F));
        m_keymap.insert(0x3A,QString(0x015E));
        m_keymap.insert(0x27,QString(0x0162));
    ...
    void addAltedKeys()
    {
        ...
        m_keymap.insert(0xB5,QString(0x00A7));
        ...
        m_keymap.insert(0xBA,QString(0x0111));
        m_keymap.insert(0xC0,QString(0x0141));
        m_keymap.insert(0xC1,QString(0x003B));
        m_keymap.insert(0xC2,QString(0x0027));
    ...
    {
        m_keymap.insert(0x5b,QString(0x103));
        m_keymap.insert(0x5c,QString(0xE2));
        m_keymap.insert(0x5d,QString(0xEE));
        m_keymap.insert(0x3a,QString(0x15E));
        m_keymap.insert(0x3b,QString(0x15F));
        m_keymap.insert(0x27,QString(0x163));
        m_keymap.insert(0x7b,QString(0x102));
        m_keymap.insert(0x7c,QString(0xC2));
        m_keymap.insert(0x7d,QString(0xCE));
        m_keymap.insert(0x22,QString(0x162));
    }
