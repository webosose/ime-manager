...
private:
    ...
    void addNormalKeys()
    {
     ...
     void addAltedKeys()
     {
         ...
         m_keymap.insert(0xB1,QString(0x01B4));
         m_keymap.insert(0xBA,QString(0x0257));
         m_keymap.insert(0xBF,QString(0x0199));
         m_keymap.insert(0xC1,QString(0x00B6));
         m_keymap.insert(0xC2,QString(0x2019));
         m_keymap.insert(0xC8,QString(0x0253));
     }

     void addAltShiftedKeys()
     {
         m_keymap.insert(0xEA,QString(0x01B3));
         m_keymap.insert(0xF4,QString(0x018A));
         m_keymap.insert(0xF8,QString(0x0198));
         m_keymap.insert(0xFE,QString(0x00A6));
         m_keymap.insert(0x103,QString(0x0181));
     }
};
