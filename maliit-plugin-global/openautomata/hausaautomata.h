...
#ifndef HAUSA_AUTOMATA_H
#define HAUSA_AUTOMATA_H

#include "automatabase.h"
#include <QLocale>

class HausaAutomata : public AutomataBase
{
...
private:
    ...
    void addNormalKeys()
    {
     ...
     void addAltedKeys()
     {
         ...
         m_keymap.insert(0xB1,QString(QChar(0x01B4)));
         m_keymap.insert(0xBA,QString(QChar(0x0257)));
         m_keymap.insert(0xBF,QString(QChar(0x0199)));
         m_keymap.insert(0xC1,QString(QChar(0x00B6)));
         m_keymap.insert(0xC2,QString(QChar(0x2019)));
         m_keymap.insert(0xC8,QString(QChar(0x0253)));
     }

     void addAltShiftedKeys()
     {
         m_keymap.insert(0xEA,QString(QChar(0x01B3)));
         m_keymap.insert(0xF4,QString(QChar(0x018A)));
         m_keymap.insert(0xF8,QString(QChar(0x0198)));
         m_keymap.insert(0xFE,QString(QChar(0x00A6)));
         m_keymap.insert(0x103,QString(QChar(0x0181)));
     }
};
#endif // HAUSA_AUTOMATA_H
