...
#ifndef TURKISH_AUTOMATA_H
#define TURKISH_AUTOMATA_H

#include "automatabase.h"
#include <QLocale>

class TurkishAutomata : public AutomataBase
{
...
public:
    TurkishAutomata()
    {
        ...
        m_keymap.insert(0x23,QString(QChar(0x5e)));
        m_keymap.insert(0x24,QString(QChar(0x2b)));
        ...
        m_keymap.insert(0x2b,QString(QChar(0x5f)));
        m_keymap.insert(0x2d,QString(QChar(0x2a)));
        ...
        m_keymap.insert(0x3d,QString(QChar(0x2d)));
        m_keymap.insert(0x3f,QString(QChar(0x3a)));
        m_keymap.insert(0x40,QString(QChar(0x60)));
        ...
        m_keymap.insert(0x5b,QString(QChar(0x11F)));
        m_keymap.insert(0x5c,QString(QChar(0x2C)));
        m_keymap.insert(0x5d,QString(QChar(0xFC)));
        ...
        m_keymap.insert(0x69,QString(QChar(0x131)));
        ...
        m_keymap.insert(0x7b,QString(QChar(0x11E)));
        m_keymap.insert(0x7c,QString(QChar(0x3b)));
        m_keymap.insert(0x7d,QString(QChar(0xDC)));
        m_keymap.insert(0x7e,QString(QChar(0xE9)));
        m_keymap.insert(0x20,QString(QChar(0x20)));
        //special characters:
        m_keymap.insert(0x3b,QString(QChar(0x15F)));
        m_keymap.insert(0x3a,QString(QChar(0x15E)));
        m_keymap.insert(0x2e,QString(QChar(0xE7)));
        m_keymap.insert(0x22,QString(QChar(0x130)));
        m_keymap.insert(0x27,QString(QChar(0x69)));
        m_keymap.insert(0x2c,QString(QChar(0xF6)));
        m_keymap.insert(0x3c,QString(QChar(0xD6)));
        m_keymap.insert(0x3e,QString(QChar(0xC7)));
    ...
    {
        return new TurkishAutomata();
    }
};

#endif // TURKISH_AUTOMATA_H
