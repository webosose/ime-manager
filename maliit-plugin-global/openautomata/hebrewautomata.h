...
#ifndef HEBREW_AUTOMATA_H
#define HEBREW_AUTOMATA_H

#include "automatabase.h"
#include <QLocale>

class HebrewAutomata : public AutomataBase
{
...
public:
    HebrewAutomata()
    {
        ...
        m_keymap.insert(0x27,QString(QChar(0x2C)));
        ...
        m_keymap.insert(0x2c,QString(QChar(0x5EA)));
        m_keymap.insert(0x2d,QString(QChar(0x2d)));
        m_keymap.insert(0x2e,QString(QChar(0x5E5)));
        ...
        m_keymap.insert(0x3b,QString(QChar(0x5E3)));
        ...
        m_keymap.insert(0x61,QString(QChar(0x5E9)));
        m_keymap.insert(0x62,QString(QChar(0x5E0)));
        m_keymap.insert(0x63,QString(QChar(0x5D1)));
        m_keymap.insert(0x64,QString(QChar(0x5D2)));
        m_keymap.insert(0x65,QString(QChar(0x5e7)));
        m_keymap.insert(0x66,QString(QChar(0x5DB)));
        m_keymap.insert(0x67,QString(QChar(0x5E2)));
        m_keymap.insert(0x68,QString(QChar(0x5D9)));
        m_keymap.insert(0x69,QString(QChar(0x5DF)));
        m_keymap.insert(0x6a,QString(QChar(0x5D7)));
        m_keymap.insert(0x6b,QString(QChar(0x5DC)));
        m_keymap.insert(0x6c,QString(QChar(0x5DA)));
        m_keymap.insert(0x6d,QString(QChar(0x5E6)));
        m_keymap.insert(0x6e,QString(QChar(0x5DE)));
        m_keymap.insert(0x6f,QString(QChar(0x5DD)));
        m_keymap.insert(0x70,QString(QChar(0x5E4)));
        m_keymap.insert(0x71,QString(QChar(0x2f)));
        m_keymap.insert(0x72,QString(QChar(0x5E8)));
        m_keymap.insert(0x73,QString(QChar(0x5D3)));
        m_keymap.insert(0x74,QString(QChar(0x5D0)));
        m_keymap.insert(0x75,QString(QChar(0x5D5)));
        m_keymap.insert(0x76,QString(QChar(0x5D4)));
        m_keymap.insert(0x77,QString(QChar(0x27)));
        m_keymap.insert(0x78,QString(QChar(0x5E1)));
        m_keymap.insert(0x79,QString(QChar(0x5D8)));
        m_keymap.insert(0x7a,QString(QChar(0x5D6)));
    ...
    {
        return new HebrewAutomata();
    }
};

#endif // HEBREW_AUTOMATA_H
