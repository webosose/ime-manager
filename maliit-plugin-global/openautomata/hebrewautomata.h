...
public:
    HebrewAutomata()
    {
        ...
        m_keymap.insert(0x27,QString(0x2C));
        ...
        m_keymap.insert(0x2c,QString(0x5EA));
        m_keymap.insert(0x2d,QString(0x2d));
        m_keymap.insert(0x2e,QString(0x5E5));
        ...
        m_keymap.insert(0x3b,QString(0x5E3));
        ...
        m_keymap.insert(0x61,QString(0x5E9));
        m_keymap.insert(0x62,QString(0x5E0));
        m_keymap.insert(0x63,QString(0x5D1));
        m_keymap.insert(0x64,QString(0x5D2));
        m_keymap.insert(0x65,QString(0x5e7));
        m_keymap.insert(0x66,QString(0x5DB));
        m_keymap.insert(0x67,QString(0x5E2));
        m_keymap.insert(0x68,QString(0x5D9));
        m_keymap.insert(0x69,QString(0x5DF));
        m_keymap.insert(0x6a,QString(0x5D7));
        m_keymap.insert(0x6b,QString(0x5DC));
        m_keymap.insert(0x6c,QString(0x5DA));
        m_keymap.insert(0x6d,QString(0x5E6));
        m_keymap.insert(0x6e,QString(0x5DE));
        m_keymap.insert(0x6f,QString(0x5DD));
        m_keymap.insert(0x70,QString(0x5E4));
        m_keymap.insert(0x71,QString(0x2f ));
        m_keymap.insert(0x72,QString(0x5E8));
        m_keymap.insert(0x73,QString(0x5D3));
        m_keymap.insert(0x74,QString(0x5D0));
        m_keymap.insert(0x75,QString(0x5D5));
        m_keymap.insert(0x76,QString(0x5D4));
        m_keymap.insert(0x77,QString(0x27));
        m_keymap.insert(0x78,QString(0x5E1));
        m_keymap.insert(0x79,QString(0x5D8));
        m_keymap.insert(0x7a,QString(0x5D6));
