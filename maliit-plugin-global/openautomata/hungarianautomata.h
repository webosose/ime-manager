...
private:
    ...
    void addSymbolKeys()
    {
        m_keymap.insert(0x21,QString(QChar(0x27)));
        m_keymap.insert(0x22,QString(QChar(0xC1)));
        m_keymap.insert(0x23,QString(QChar(0x2B)));
        m_keymap.insert(0x24,QString(QChar(0x21)));
        m_keymap.insert(0x25,QString(QChar(0x25)));
        m_keymap.insert(0x26,QString(QChar(0x3D)));
        m_keymap.insert(0x27,QString(QChar(0xE1)));
        m_keymap.insert(0x28,QString(QChar(0x29)));
        m_keymap.insert(0x29,QString(QChar(0xD6)));
        m_keymap.insert(0x2a,QString(QChar(0x28)));
        m_keymap.insert(0x2b,QString(QChar(0xD3)));
        m_keymap.insert(0x2c,QString(QChar(0x2c)));
        m_keymap.insert(0x2d,QString(QChar(0xFc)));
    ...
    void addNumberKeys()
    {
        m_keymap.insert(0x30,QString(QChar(0xF6)));
    ...
    void addShiftKeys()
    {
        m_keymap.insert(0x3a,QString(QChar(0xC9)));
        m_keymap.insert(0x3b,QString(QChar(0xE9)));
        m_keymap.insert(0x3c,QString(QChar(0x3F)));
        m_keymap.insert(0x3d,QString(QChar(0xF3)));
        ...
        m_keymap.insert(0x5b,QString(QChar(0x151)));
        m_keymap.insert(0x5c,QString(QChar(0x171)));
        m_keymap.insert(0x5d,QString(QChar(0xFA)));
        m_keymap.insert(0x5e,QString(QChar(0x2F)));
        m_keymap.insert(0x5f,QString(QChar(0xDC)));
    }

    void addNormalKeys()
    {
        m_keymap.insert(0x60,QString(QChar(0x30)));
        ...
        m_keymap.insert(0x7b,QString(QChar(0x150)));
        m_keymap.insert(0x7c,QString(QChar(0x170)));
        m_keymap.insert(0x7d,QString(QChar(0xDA)));
    ...
    void addAccentKeys()
    {
        m_keymap.insert(0x00e1,QString(QChar(0xE1)));
        m_keymap.insert(0x00e9,QString(QChar(0xe9)));
        m_keymap.insert(0x00ed,QString(QChar(0xed)));
        m_keymap.insert(0x00f3,QString(QChar(0xf3)));
        m_keymap.insert(0x00f5,QString(QChar(0xf5)));
        m_keymap.insert(0x00f6,QString(QChar(0xf6)));
        m_keymap.insert(0x01f5,QString(QChar(0x151)));
        m_keymap.insert(0x00fa,QString(QChar(0xfa)));
        m_keymap.insert(0x00fc,QString(QChar(0xfc)));
        m_keymap.insert(0x01fb,QString(QChar(0x171)));
        m_keymap.insert(0x01c1,QString(QChar(0xc1)));
        m_keymap.insert(0x003a,QString(QChar(0xc9)));
        m_keymap.insert(0x00B3,QString(QChar(0xcd)));
        m_keymap.insert(0x00d3,QString(QChar(0xd3)));
        m_keymap.insert(0x00d5,QString(QChar(0xd5)));
        m_keymap.insert(0x00d6,QString(QChar(0xd6)));
        m_keymap.insert(0x01d5,QString(QChar(0x150)));
        m_keymap.insert(0x00da,QString(QChar(0xda)));
        m_keymap.insert(0x00dc,QString(QChar(0xdc)));
        m_keymap.insert(0x01db,QString(QChar(0x170)));
        m_keymap.insert(0x003F1,QString(QChar(0x3F)));
        m_keymap.insert(0x00401,QString(QChar(0x40)));
    }
    ...
    void addAltKeysForHID()
    {
        ...
        m_keymap.insert(0xAE,QString(QChar(0x00C4)));
        m_keymap.insert(0xB2,QString(QChar(0x20AC)));
        m_keymap.insert(0xB3,QString(QChar(0x00CD)));
        m_keymap.insert(0xB6,QString(QChar(0x00F7)));
        m_keymap.insert(0xB7,QString(QChar(0x00D7)));
        m_keymap.insert(0xB8,QString(QChar(0x00E4)));
        ...
        m_keymap.insert(0xBE,QString(QChar(0x00ED)));
        ...
        m_keymap.insert(0xC5,QString(QChar(0x003E)));
        ...
        m_keymap.insert(0xCB,QString(QChar(0x003C)));
        m_keymap.insert(0xCC,QString(QChar(0x003B)));
