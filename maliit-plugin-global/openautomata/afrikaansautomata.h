...
#ifndef AFRIKAANS_AUTOMATA_H
#define AFRIKAANS_AUTOMATA_H

#include "automatabase.h"
#include <QLocale>

class AfrikaansAutomata : public AutomataBase
{
...
public:
    ...
    {
        return new AfrikaansAutomata();
    }
};

#endif // AFRIKAANS_AUTOMATA_H
