...
private:
    void addAccentKeys()
    {
        m_keymap.insert(0x21,QString(0x104));
        m_keymap.insert(0x22,QString(0x22));
        m_keymap.insert(0x23,QString(0x118));
        m_keymap.insert(0x24,QString(0x116));
        m_keymap.insert(0x25,QString(0x12E));
        m_keymap.insert(0x26,QString(0x172));
        m_keymap.insert(0x27,QString(0x27));
        m_keymap.insert(0x28,QString(0x28));
        m_keymap.insert(0x29,QString(0x29));
        m_keymap.insert(0x2a,QString(0x16A));
        m_keymap.insert(0x2b,QString(0x17D));
    ...
    void addNumberKeys()
    {
        ...
        m_keymap.insert(0x31,QString(0x105));
        m_keymap.insert(0x32,QString(0x10D));
        m_keymap.insert(0x33,QString(0x119));
        m_keymap.insert(0x34,QString(0x117));
        m_keymap.insert(0x35,QString(0x12F));
        m_keymap.insert(0x36,QString(0x161));
        m_keymap.insert(0x37,QString(0x173));
        m_keymap.insert(0x38,QString(0x16B));
    ...
    void addShiftKeys()
    {
        ...
        m_keymap.insert(0x3d,QString(0x17E));
        m_keymap.insert(0x3e,QString(0x3e));
        m_keymap.insert(0x3f,QString(0x3f));
        m_keymap.insert(0x40,QString(0x10C));
        ...
        m_keymap.insert(0x5e,QString(0x160));
