...
#ifndef TATAR_AUTOMATA_H
#define TATAR_AUTOMATA_H

#include "automatabase.h"
#include <QLocale>

class TatarAutomata: public AutomataBase
{
...
public:
    ...
    {
        return new TatarAutomata();
    }

private:
    void addNumberKeys()
    {
        m_keymap.insert(0x60,QString(QChar(0x04BB)));
    ...
    void addNormalKeys()
    {
        ...
        m_keymap.insert(0x77,QString(QChar(0x04E9)));
        ...
        m_keymap.insert(0x3B,QString(QChar(0x04A3)));
        ...
        m_keymap.insert(0x6D,QString(QChar(0x0497)));
    ...
    void addShiftedKeys()
    {
        m_keymap.insert(0x7E,QString(QChar(0x04BA)));
        ...
        m_keymap.insert(0x57,QString(QChar(0x04E8)));
        ...
        m_keymap.insert(0x4F,QString(QChar(0x04d8)));
        m_keymap.insert(0x50,QString(QChar(0x0417)));
        m_keymap.insert(0x7B,QString(QChar(0x0425)));
        m_keymap.insert(0x7D,QString(QChar(0x04AE)));
        m_keymap.insert(0x41,QString(QChar(0x0424)));
        m_keymap.insert(0x53,QString(QChar(0x042B)));
        ...
        m_keymap.insert(0x3A,QString(QChar(0x04A2)));
        ...
        m_keymap.insert(0x4D,QString(QChar(0x0496)));
    ...
    void addAccentKeys()
    {
       m_keymap.insert(0xC3,QString(QChar(0x451)));
       m_keymap.insert(0xFD,QString(QChar(0x401)));
    }
    ...
    void addAltKeysForHID()
    {
      ...
      m_keymap.insert(0xA6,QString(QChar(0x5B)));
      m_keymap.insert(0xA7,QString(QChar(0x5D)));
      m_keymap.insert(0xA8,QString(QChar(0x7B)));
      m_keymap.insert(0xA9,QString(QChar(0x7D)));
      m_keymap.insert(0xAD,QString(QChar(0x0446)));
      m_keymap.insert(0xB4,QString(QChar(0x0449)));
      m_keymap.insert(0xB7,QString(QChar(0x044A)));
      m_keymap.insert(0xC1,QString(QChar(0x0436)));
      m_keymap.insert(0xC2,QString(QChar(0x27)));
      m_keymap.insert(0xCB,QString(QChar(0x044C)));
    ...
    {
      m_keymap.insert(0xE1,QString(QChar(0x20BD)));
      m_keymap.insert(0xE7,QString(QChar(0x0426)));
      m_keymap.insert(0xEE,QString(QChar(0x0429)));
      m_keymap.insert(0xF1,QString(QChar(0x042A)));
      m_keymap.insert(0xFB,QString(QChar(0x0416)));
      m_keymap.insert(0x0105,QString(QChar(0x042C)));
    }
};

#endif // TATAR_AUTOMATA_H
