...
private:
    void addNumberKeys()
    {
        m_keymap.insert(0x60,QString(0x04BB));
    ...
    void addNormalKeys()
    {
        ...
        m_keymap.insert(0x77,QString(0x04E9));
        ...
        m_keymap.insert(0x3B,QString(0x04A3));
        ...
        m_keymap.insert(0x6D,QString(0x0497));
    ...
    void addShiftedKeys()
    {
        m_keymap.insert(0x7E,QString(0x04BA));
        ...
        m_keymap.insert(0x57,QString(0x04E8));
        ...
        m_keymap.insert(0x4F,QString(0x04d8));
        m_keymap.insert(0x50,QString(0x0417));
        m_keymap.insert(0x7B,QString(0x0425));
        m_keymap.insert(0x7D,QString(0x04AE));
        m_keymap.insert(0x41,QString(0x0424));
        m_keymap.insert(0x53,QString(0x042B));
        ...
        m_keymap.insert(0x3A,QString(0x04A2));
        ...
        m_keymap.insert(0x4D,QString(0x0496));
    ...
    void addAccentKeys()
    {
       m_keymap.insert(0xC3,QString(0x451));
       m_keymap.insert(0xFD,QString(0x401));
    }
    ...
    void addAltKeysForHID()
    {
      ...
      m_keymap.insert(0xA6,QString(0x5B));
      m_keymap.insert(0xA7,QString(0x5D));
      m_keymap.insert(0xA8,QString(0x7B));
      m_keymap.insert(0xA9,QString(0x7D));
      m_keymap.insert(0xAD,QString(0x0446));
      m_keymap.insert(0xB4,QString(0x0449));
      m_keymap.insert(0xB7,QString(0x044A));
      m_keymap.insert(0xC1,QString(0x0436));
      m_keymap.insert(0xC2,QString(0x27));
      m_keymap.insert(0xCB,QString(0x044C));
    ...
    {
      m_keymap.insert(0xE1,QString(0x20BD));
      m_keymap.insert(0xE7,QString(0x0426));
      m_keymap.insert(0xEE,QString(0x0429));
      m_keymap.insert(0xF1,QString(0x042A));
      m_keymap.insert(0xFB,QString(0x0416));
      m_keymap.insert(0x0105,QString(0x042C));
    }
};
