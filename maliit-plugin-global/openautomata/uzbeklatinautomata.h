...
#ifndef UZBEK_LATIN_AUTOMATA_H
#define UZBEK_LATIN_AUTOMATA_H

#include "automatabase.h"
#include <QLocale>

class UzbekLatinAutomata : public AutomataBase
{
...
private:
    ...
    void addShiftedKeys()
    {
        m_keymap.insert(0x3a,QString("G‘"));
        m_keymap.insert(0x3b,QString("g‘"));
        ...
        m_keymap.insert(0x57,QString("O‘"));
    ...
    void addNormalKeys()
    {
        m_keymap.insert(0x5b,QString("sh"));
        m_keymap.insert(0x5c,QString(QChar(0x5c)));
        m_keymap.insert(0x5d,QString("ch"));
    ...
    void addAccentKeys()
    {
        m_keymap.insert(0xAE,QString(QChar(0xEB)));
        m_keymap.insert(0xE8,QString(QChar(0xCB)));
    }
};

#endif // UZBEK_LATIN_AUTOMATA_H
