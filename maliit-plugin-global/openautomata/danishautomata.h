...
private:
    ...
    void addSymbolKeys()
    {
        m_keymap.insert(0x60,QString(0xBD));
        m_keymap.insert(0x3B,QString(0xE6));
        m_keymap.insert(0x3A,QString(0xC6));
        m_keymap.insert(0x27,QString(0xF8));
        m_keymap.insert(0x22,QString(0xD8));
    ...
    void addAltKeysForHID()
    {
        ...
        m_keymap.insert(0xAB,QString(0x007C));
