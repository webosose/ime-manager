...
public:
    KurdishAutomata()
    {
        ...
        m_keymap.insert(0x41,QString(0x64D));
        ...
        m_keymap.insert(0x53,QString(0x650));
        ...
        m_keymap.insert(0x5a,QString(0x7E));
        m_keymap.insert(0x5b,QString(0x62C));
        m_keymap.insert(0x5c,QString(0x5c));
        m_keymap.insert(0x5d,QString(0x62F));
        ...
        m_keymap.insert(0x7b,QString(0x3E));
        m_keymap.insert(0x7c,QString(0x7c));
        m_keymap.insert(0x7d,QString(0x3C));
        m_keymap.insert(0x7e,QString(0x651));
        m_keymap.insert(0x20,QString(0x20));
        //numbers
        m_keymap.insert(0x1000661,QString(0x661));
        m_keymap.insert(0x1000662,QString(0x662));
        m_keymap.insert(0x1000663,QString(0x663));
        m_keymap.insert(0x1000664,QString(0x664));
        m_keymap.insert(0x1000665,QString(0x665));
        m_keymap.insert(0x1000666,QString(0x666));
        m_keymap.insert(0x1000667,QString(0x667));
        m_keymap.insert(0x1000668,QString(0x668));
        m_keymap.insert(0x1000669,QString(0x669));
        m_keymap.insert(0x1000660,QString(0x660));
        m_keymap.insert(0x003F11,QString(0x003F));
    }
