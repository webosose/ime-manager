...
#ifndef BELARUSIAN_AUTOMATA_H
#define BELARUSIAN_AUTOMATA_H

#include "automatabase.h"
#include <QLocale>

class BelarusianAutomata: public AutomataBase
{
...
private:
    ...
    void addNormalKeys()
    {
        ...
        m_keymap.insert(0x6F,QString(QChar(0x045e)));
        ...
        m_keymap.insert(0x62,QString(QChar(0x0456)));
    ...
    void addShiftedKeys()
    {
        ...
        m_keymap.insert(0x4F,QString(QChar(0x040E)));
        m_keymap.insert(0x50,QString(QChar(0x0417)));
        m_keymap.insert(0x7B,QString(QChar(0x0425)));
        m_keymap.insert(0x7D,QString(QChar(0x0027)));
        ...
        m_keymap.insert(0x42,QString(QChar(0x0406)));
