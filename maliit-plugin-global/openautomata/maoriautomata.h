...
private:
    ...
    void addAccentKeys()
    {
        m_keymap.insert(0x0101,QString(0x0101));
        m_keymap.insert(0x0113,QString(0x0113));
        m_keymap.insert(0x012B,QString(0x012B));
        m_keymap.insert(0x014D,QString(0x014D));
        m_keymap.insert(0x016B,QString(0x016B));
        m_keymap.insert(0x0100,QString(0x0100));
        m_keymap.insert(0x0112,QString(0x0112));
        m_keymap.insert(0x012A,QString(0x012A));
        m_keymap.insert(0x014C,QString(0x014C));
        m_keymap.insert(0x016A,QString(0x016A));
    }

    void addCombiningMacros()
    {
        m_accentKeymap.insert(QString(0x0060)+QString(0x61),QString(0x0101));
        m_accentKeymap.insert(QString(0x0060)+QString(0x65),QString(0x0113));
        m_accentKeymap.insert(QString(0x0060)+QString(0x69),QString(0x012B));
        m_accentKeymap.insert(QString(0x0060)+QString(0x6F),QString(0x014D));
        m_accentKeymap.insert(QString(0x0060)+QString(0x75),QString(0x016B));
        m_accentKeymap.insert(QString(0x0060)+QString(0x41),QString(0x0100));
        m_accentKeymap.insert(QString(0x0060)+QString(0x45),QString(0x0112));
        m_accentKeymap.insert(QString(0x0060)+QString(0x49),QString(0x012A));
        m_accentKeymap.insert(QString(0x0060)+QString(0x4F),QString(0x014C));
        m_accentKeymap.insert(QString(0x0060)+QString(0x55),QString(0x016A));
    }
};
