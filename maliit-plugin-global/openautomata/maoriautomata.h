...
#ifndef MAORI_AUTOMATA_H
#define MAORI_AUTOMATA_H

#include "automatabase.h"
#include <QLocale>

class MaoriAutomata : public AutomataBase
{
...
private:
    ...
    void addAccentKeys()
    {
        m_keymap.insert(0x0101,QString(QChar(0x0101)));
        m_keymap.insert(0x0113,QString(QChar(0x0113)));
        m_keymap.insert(0x012B,QString(QChar(0x012B)));
        m_keymap.insert(0x014D,QString(QChar(0x014D)));
        m_keymap.insert(0x016B,QString(QChar(0x016B)));
        m_keymap.insert(0x0100,QString(QChar(0x0100)));
        m_keymap.insert(0x0112,QString(QChar(0x0112)));
        m_keymap.insert(0x012A,QString(QChar(0x012A)));
        m_keymap.insert(0x014C,QString(QChar(0x014C)));
        m_keymap.insert(0x016A,QString(QChar(0x016A)));
    }

    void addCombiningMacros()
    {
        m_accentKeymap.insert(QString(QChar(0x0060))+QString(QChar(0x61)),QString(QChar(0x0101)));
        m_accentKeymap.insert(QString(QChar(0x0060))+QString(QChar(0x65)),QString(QChar(0x0113)));
        m_accentKeymap.insert(QString(QChar(0x0060))+QString(QChar(0x69)),QString(QChar(0x012B)));
        m_accentKeymap.insert(QString(QChar(0x0060))+QString(QChar(0x6F)),QString(QChar(0x014D)));
        m_accentKeymap.insert(QString(QChar(0x0060))+QString(QChar(0x75)),QString(QChar(0x016B)));
        m_accentKeymap.insert(QString(QChar(0x0060))+QString(QChar(0x41)),QString(QChar(0x0100)));
        m_accentKeymap.insert(QString(QChar(0x0060))+QString(QChar(0x45)),QString(QChar(0x0112)));
        m_accentKeymap.insert(QString(QChar(0x0060))+QString(QChar(0x49)),QString(QChar(0x012A)));
        m_accentKeymap.insert(QString(QChar(0x0060))+QString(QChar(0x4F)),QString(QChar(0x014C)));
        m_accentKeymap.insert(QString(QChar(0x0060))+QString(QChar(0x55)),QString(QChar(0x016A)));
    }
};

#endif // MAORI_AUTOMATA_H
