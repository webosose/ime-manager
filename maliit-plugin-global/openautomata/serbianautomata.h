...
#ifndef SERBIAN_HUTOMATA_H
#define SERBIAN_HUTOMATA_H

#include "automatabase.h"
#include <QLocale>

class SerbianAutomata : public AutomataBase
{
...
private:
    ...
    void addShiftKeys()
    {
        ...
        m_keymap.insert(0x5b,QString(QChar(0x161)));
    ...
    void addAltKeysForHID()
    {
        ...
        m_keymap.insert(0xCB,QString(QChar(0xA7)));
