...
private:
    ...
    void addSymbolKeys()
    {
        m_keymap.insert(0x60,QString(QChar(0x02DB)));
        m_keymap.insert(0x7E,QString(QChar(0x02D9)));
        ...
        m_keymap.insert(0x5C,QString(QChar(0x00F3)));
        m_keymap.insert(0x7C,QString(QChar(0x017A)));
        m_keymap.insert(0x5B,QString(QChar(0x017C)));
        m_keymap.insert(0x7B,QString(QChar(0x0144)));
        m_keymap.insert(0x5D,QString(QChar(0x015B)));
        m_keymap.insert(0x7D,QString(QChar(0x0107)));
        m_keymap.insert(0x3B,QString(QChar(0x0142)));
        m_keymap.insert(0x3A,QString(QChar(0x0141)));
        m_keymap.insert(0x27,QString(QChar(0x0105)));
    ...
    void addAltedKeys()
    {
        ...
        m_keymap.insert(0xAD,QString(QChar(0x00A6)));
    ...
    void addAccentKeys()
    {
        m_keymap.insert(0x01b1,QString(QChar(0x105)));
        m_keymap.insert(0x01e6,QString(QChar(0x107)));
        m_keymap.insert(0x01ea,QString(QChar(0x119)));
        m_keymap.insert(0x01b3,QString(QChar(0x142)));
        m_keymap.insert(0x01f1,QString(QChar(0x144)));
        m_keymap.insert(0x00f3,QString(QChar(0xf3)));
        m_keymap.insert(0x01b6,QString(QChar(0x15b)));
        m_keymap.insert(0x01bc,QString(QChar(0x17a)));
        m_keymap.insert(0x01bf,QString(QChar(0x17c)));
        m_keymap.insert(0x01a1,QString(QChar(0x104)));
        m_keymap.insert(0x01c6,QString(QChar(0x106)));
        m_keymap.insert(0x01ca,QString(QChar(0x118)));
        m_keymap.insert(0x01a3,QString(QChar(0x141)));
        m_keymap.insert(0x01d1,QString(QChar(0x143)));
        m_keymap.insert(0x00d3,QString(QChar(0xd3)));
        m_keymap.insert(0x01a6,QString(QChar(0x15a)));
        m_keymap.insert(0x01ac,QString(QChar(0x179)));
        m_keymap.insert(0x01af,QString(QChar(0x17b)));
    }
