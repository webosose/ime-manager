...
private:
    ...
    void addAltKeysForHID()
    {
        ...
        m_keymap.insert(0xB2,QString(QChar(0x1ee5)));
        m_keymap.insert(0xB3,QString(QChar(0x1ecb)));
        m_keymap.insert(0xB4,QString(QChar(0x1ecd)));
        ...
        m_keymap.insert(0xCA,QString(QChar(0x1e45)));
    ...
    void addAltShiftedKeysForHID()
    {
        ...
        m_keymap.insert(0xEC,QString(QChar(0x1ee4)));
        m_keymap.insert(0xED,QString(QChar(0x1eca)));
        m_keymap.insert(0xEE,QString(QChar(0x1ecc)));
        ...
        m_keymap.insert(0x104,QString(QChar(0x1e44)));
