...
private:
    void addSymbolKeys()
    {
        ...
        m_keymap.insert(0x23,QString(QChar(0x20AC)));
        ...
        m_keymap.insert(0x5C,QString(QChar(0x017C)));
        m_keymap.insert(0x7C,QString(QChar(0x017B)));
        m_keymap.insert(0x2D,QString(QChar(0x2D)));
        m_keymap.insert(0x3D,QString(QChar(0x3D)));
        m_keymap.insert(0x1A,QString(QChar(0x23)));
        m_keymap.insert(0x1B,QString(QChar(0x7E)));
    }
    ...
    void addShiftKeys()
    {
        ...
        m_keymap.insert(0x7B,QString(QChar(0x0120)));
        m_keymap.insert(0x7D,QString(QChar(0x0126)));
        ...
        m_keymap.insert(0x22,QString(QChar(0x40)));
    ...
    void addNormalKeys()
    {
        ...
        m_keymap.insert(0x5B,QString(QChar(0x0121)));
        m_keymap.insert(0x5D,QString(QChar(0x0127)));
     ...
     {
         //lower case
        m_keymap.insert(0x60,QString(QChar(0x010b)));
        m_keymap.insert(0x017c,QString(QChar(0x017c)));
         //upper case
        m_keymap.insert(0x7E,QString(QChar(0x010a)));
        m_keymap.insert(0x017b,QString(QChar(0x017b)));
     }
     ...
     void addAltKeysForHID()
     {
        ...
        m_keymap.insert(0xAE,QString(QChar(0xE8)));
        m_keymap.insert(0xB2,QString(QChar(0xF9)));
        m_keymap.insert(0xB3,QString(QChar(0xEC)));
        m_keymap.insert(0xB4,QString(QChar(0xF2)));
        m_keymap.insert(0xB6,QString(QChar(0x5B)));
        m_keymap.insert(0xB7,QString(QChar(0x5D)));
        m_keymap.insert(0xB8,QString(QChar(0xE0)));
     }

     void addShiftedAltKeysForHID()
     {
        m_keymap.insert(0xFD,QString(QChar(0xAC)));
        m_keymap.insert(0xE8,QString(QChar(0xC8)));
        m_keymap.insert(0xEC,QString(QChar(0xD9)));
        m_keymap.insert(0xED,QString(QChar(0xCC)));
        m_keymap.insert(0xEE,QString(QChar(0xD2)));
        m_keymap.insert(0xF0,QString(QChar(0x7B)));
        m_keymap.insert(0xF1,QString(QChar(0x7D)));
        m_keymap.insert(0xF2,QString(QChar(0xC0)));
     }
};
