...
class STTInputMethod
    : public MAbstractInputMethod
{
    Q_OBJECT

public:
    STTInputMethod(MAbstractInputMethodHost *host);
    ~STTInputMethod();
...
private:
    QScopedPointer<Maliit::Plugins::AbstractPluginSetting> accessoryEnabled;
};
